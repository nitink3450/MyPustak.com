    ...
    return (
        <Fragment>
            {cart.length > 0 ? <Fragment>
                <h3 style={{ marginLeft: "10px",fontFamily:"cursive",color:"violet"}}>Cart Books...</h3>
                <div className="row">
                    {cart.map(item =>
            ...
            </Fragment> : <h2 style={{ margin: "270px",fontFamily:"cursive",color:"red",display:"flex",justifyContent:"center"}} >Your Cart Is Empty, Kindly Add Books...</h2>}
        </Fragment>
    )
}
